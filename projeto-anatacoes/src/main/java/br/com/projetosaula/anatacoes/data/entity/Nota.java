package br.com.projetosaula.anatacoes.data.entity;
...
public class Nota {
	...
	@ManyToOne
	@JoinColumn(name="id_categoria") //vai criar uma coluna chave estrangeira na tabela Nota (Referencia ID Categoria)
